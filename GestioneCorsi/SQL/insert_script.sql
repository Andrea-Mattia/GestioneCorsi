...
insert into corso values(1, 1, 'Java', TO_DATE('17/12/2020', 'DD/MM/YYYY'), TO_DATE('20/12/2020', 'DD/MM/YYYY'), 1200, 'Potrebbe essere leggermente complesso ma soddisfacente', 'AX12');
insert into corso values(2, 1, 'PHP', TO_DATE('19/02/2019', 'DD/MM/YYYY'), TO_DATE('30/12/2019', 'DD/MM/YYYY'), 3000, 'Corso di PHP della durata complessivamente giusta', 'JS22');
insert into corso values(3, 2, 'XML', TO_DATE('17/05/2022', 'DD/MM/YYYY'), TO_DATE('20/12/2022', 'DD/MM/YYYY'), 2200, '', 'AL88');
insert into corso values(4, 2, 'SQL', TO_DATE('01/06/2022', 'DD/MM/YYYY'), TO_DATE('01/10/2022', 'DD/MM/YYYY'), 3500, 'Questo lo seguirei volentieri', 'FS15');
insert into corso values(5, 2, 'HTML5', TO_DATE('06/03/2022', 'DD/MM/YYYY'), TO_DATE('20/10/2022', 'DD/MM/YYYY'), 6000, 'Acido desossiribonucleico', 'AJ81');
